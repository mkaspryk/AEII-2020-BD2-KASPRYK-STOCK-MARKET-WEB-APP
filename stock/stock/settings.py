...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'quick_purchase.context_processors.quick_buy_form_context',
                'quick_purchase.context_processors.available_currencies_context',
                'portfolio.context_processor.user_balance_context',
            ],
        },
    },
]
